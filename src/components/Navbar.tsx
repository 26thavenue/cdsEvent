    ...
    <nav className="bg-[#0B3D2E] text-white py-8 px-6 lg:px-24 relative z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex space-x-8 items-center text-white font-medium">
          ...
          <Link to="/location" className="hover:text-yellow-500 transition-colors">Location</Link>
          <Link to="/register" className="hover:bg-yellow-500 px-4 py-2 rounded transition-colors border border-white">Register</Link>
        </div>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-full bg-white text-primary z-50 flex flex-col p-6 space-y-6 pt-6">
             ...
             <div className="flex  my-4 justify-end justify-between items-center mb-4">
            ...
            <Link to="/location" onClick={toggleMenu} className="hover:text-yellow-500 transition-colors">Location</Link>
